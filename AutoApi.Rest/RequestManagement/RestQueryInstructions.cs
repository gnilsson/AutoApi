...
//public class RestQueryInstructions<TEntity> : IQueryInstructions<TEntity> where TEntity : class, IEntity
//{
//    public IQueryInstructions<TEntity> .QueryDelegate Query { get; }


//    public RestQueryInstructions(ConfigurationDefinition.Entity[] foreignEntityDefinitions)
//    {
//        Query = QueryHandle;
//    }
