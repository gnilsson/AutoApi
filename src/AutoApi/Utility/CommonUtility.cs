...
public static class CommonUtility
{
    ...
    public static string AppendQueryString(this string uri, string queryName, string queryValue) => QueryHelpers.AddQueryString(uri, queryName, queryValue);
    ...
    public static string ToLongDateTimeString(this DateTime dateTime) => dateTime.ToString("dddd, dd MMMM yyyy HH:mm");
}
